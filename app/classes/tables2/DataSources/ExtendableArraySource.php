 ...
 *
 */
abstract class ExtendableArraySource extends \Nette\Object implements \Juz\Tables\IDataSource {
  protected $list = null;
  protected $keys = null;
  ...
  protected function initialize() {
    ...
    $list = $this->_initialize();
    if(!is_array($list)) throw new \LogicException('_initialize method should return array');

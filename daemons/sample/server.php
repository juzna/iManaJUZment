...
class SharedServiceHandler implements SharedServiceIf {
	public function getStruct($key) {
		return new SharedStruct(array('key' => $key, 'value' => "Ahoj $key"));
	}
}
...
$processor = new SharedServiceProcessor($handler);

$unixPath = realpath(__DIR__ . '/../../') . '/temp/sock/sample';
@unlink($unixPath);
